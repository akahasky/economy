...
public class AddBalanceCommand extends Command {
    ...
    public AddBalanceCommand(IRepository repository, EconomyCache economyCache) {

        super("addbalance");

        setDescription("Add balance to another player.");
    ...
    public boolean execute(CommandSender commandSender, String label, String[] arguments) {
        ...
        BigDecimal currentMoney = economyCache.get(target.getName());
        BigDecimal newMoney = currentMoney.add(BigDecimal.valueOf(amount));
